...
#ifdef DS_IMPLEMENT_DOUBLE_LINKED_LIST
#define DS_IMPLEMENT_LIST
#include "list.h"
#undef DS_IMPLEMENT_LIST
#endif // DS_IMPLEMENT_DOUBLE_LINKED_LIST
...
typedef void* ds_double_linked_list_t;

#ifdef DS_IMPLEMENT_DOUBLE_LINKED_LIST
struct _ds_double_linked_list {
	struct _ds_list;
	size_t size;
	void* head;
	void* tail;
...
*/
extern void* ds_double_linked_list_front(const ds_double_linked_list_t this);
...
*/
extern void* ds_double_linked_list_back(const ds_double_linked_list_t this);
...
*/
extern iterator_t ds_double_linked_list_begin(
...
*/
extern iterator_t ds_double_linked_list_end(const ds_double_linked_list_t this);
...
*/
extern bool ds_double_linked_list_empty(const ds_double_linked_list_t this);
...
*/
extern size_t ds_double_linked_list_size(const ds_double_linked_list_t this);
...
* @return	This function returns no value.
*/
extern void ds_double_linked_list_clear(const ds_double_linked_list_t this);
...
* @return	This function returns no value.
*/
extern void ds_double_linked_list_pop_front(const ds_double_linked_list_t this);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t ds_double_linked_list_sort(const ds_double_linked_list_t this,
	errno_t(*comp)(const void* a, const void* b, bool* result));

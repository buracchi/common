...
*/
extern void common_map_destroy(
	const common_map_t this
);
...
*/
extern common_iterator_t common_map_begin(
	const common_map_t this
);
...
*/
extern common_iterator_t common_map_end(
	const common_map_t this
);
...
*/
extern common_iterator_t common_map_insert(
	const common_map_t this,
	const void* key, 
	const void* value
);
...
*			returns NULL.
*/
extern common_iterator_t common_map_insert_or_assign(
	const common_map_t this,
	const void* key,
	const void* value
);
...
*/
extern common_iterator_t common_map_erase(
	const common_map_t this,
	const common_iterator_t position
);
...
*/
extern errno_t common_map_merge(
	const common_map_t this,
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_map_remove(
	const common_map_t this, 
	const void* key,
	errno_t(*comp)(const void* a, const void* b, bool* result),
	size_t* removed
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_map_remove_if(
	const common_map_t this,
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_map_count(
	const common_map_t this,
	const void* key,
	errno_t(*comp)(const void* a, const void* b, bool* result),
	size_t* count
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_map_find(
	const common_map_t this, 
	const void* key,
	errno_t(*comp)(const void* a, const void* b, bool* result),
	common_iterator_t* iterator
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_map_contains(
	const common_map_t this,
	const void* key,
	errno_t(*comp)(const void* a, const void* b, bool* result),
	bool* exists

...
struct _common_list {
	...
	// Iterators
	common_iterator_t (*_begin)(
		const common_list_t this
	);
	common_iterator_t (*_end)(
		const common_list_t this
	);
	// Capacity
	bool (*_empty)(
	...
	common_iterator_t (*_insert)(
		const common_list_t this, 
		const common_iterator_t position,
		const void* value
	);
	common_iterator_t (*_erase)(
		const common_list_t this, 
		const common_iterator_t position
	);
	errno_t (*_push_front)(
	...
	void (*_splice)(
		const common_list_t this,
		const common_list_t other,
		const common_iterator_t pos,
		const common_iterator_t first,
...
*/
extern void common_list_destroy(
	const common_list_t this
);
...
*/
extern common_iterator_t common_list_begin(
	const common_list_t this
);
...
*/
extern common_iterator_t common_list_end(
	const common_list_t this
);
...
*/
extern size_t common_list_size(
	const common_list_t this
);
...
*/
extern common_iterator_t common_list_insert(
	const common_list_t this,
	const common_iterator_t position,
	const void* value
);
...
*/
extern common_iterator_t common_list_erase(
	const common_list_t this,
	const common_iterator_t position
);
...
*/
extern errno_t common_list_push_front(
	const common_list_t this,
	const void* value
);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_push_back(
	const common_list_t this,
	const void* value
);
...
* @return	This function returns no value.
*/
extern void common_list_pop_front(
	const common_list_t this
);
...
* @return	This function returns no value.
*/
extern void common_list_pop_back(
	const common_list_t this
);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_resize(
	const common_list_t this,
	const size_t s,
	const void* value
);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_merge(
	const common_list_t this,
	const common_list_t other,
	errno_t (*comp)(
		const void* a,
...
* @return	This function returns no value.
*/
extern void common_list_splice(
	const common_list_t this,
	const common_list_t other,
	const common_iterator_t position,
	const common_iterator_t first,
...
*/
extern size_t common_list_remove(
	const common_list_t this,
	void* value
);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_remove_if(
	const common_list_t this,
	errno_t (*pred)(
		const void* a,
		bool* result
...
* @return	This function returns no value.
*/
extern void common_list_reverse(
	const common_list_t this
);
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_unique(
	const common_list_t this,
	errno_t (*comp)(
		const void* a,
		const void* b,
...
* @return	On success, this function returns zero.  On error, an errno [...].
*/
extern errno_t common_list_sort(
	const common_list_t this,
	errno_t(*comp)(
		const void* a,
		const void* b,

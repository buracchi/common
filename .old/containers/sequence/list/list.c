...
extern inline errno_t common_list_resize(
...
extern inline void common_list_swap(
	const common_list_t this, 
...
extern inline errno_t common_list_merge(
	const common_list_t this,
	const common_list_t other,
...
extern inline void common_list_splice(
	const common_list_t this, 
	const common_list_t other,
...
extern inline errno_t common_list_unique(
	const common_list_t this,
	errno_t(*comp)(const void* a, const void* b, bool* result),
	size_t* removed) {
	struct _common_list* _this = this;

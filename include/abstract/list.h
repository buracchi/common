...
*
* @param	this	-	the list to destroy.
* 
...
*
* @param	this	-	the list containing the element.
...
*
* @param	this		-	the list where the element will be inserted.
...
*
* @param	this	-	the list where the element will be erased.
...
*
* @param	this	-	the list where the element will be removed.
* @return	0 on success; non-zero otherwise.
*/
...
*
* @param	this	-	the list to exchange contents with.
...
*
* @param this	-	the list to merge with.
...
*
* @param this	-	the list
* @param p		-	unary function which set a boolean as true if the element
*					should be removed.
*
* @return 0 on success; non-zero otherwise.
*/

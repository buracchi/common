...
static inline void avl_tree_set_root(avl_tree_t handle, avl_tree_node_t node) { bst_set_root(handle, node); }

static inline void avl_tree_insert_as_left_subtree(avl_tree_t handle, avl_tree_node_t node, avl_tree_t subtree) { bst_insert_as_left_subtree(handle, node, subtree); }

static inline void avl_tree_insert_as_right_subtree(avl_tree_t handle, avl_tree_node_t node, avl_tree_t subtree) { bst_insert_as_right_subtree(handle, node, subtree); }
...
static inline void avl_tree_insert_single_node_tree(avl_tree_t handle, void* key, avl_tree_t new_tree) { bst_insert_single_node_tree(handle, key, new_tree); }

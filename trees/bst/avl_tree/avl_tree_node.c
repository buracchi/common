...
extern inline int avl_tree_node_set_father(avl_tree_node_t handle, avl_tree_node_t father) {
	struct avl_tree_node* avl_tree_node = (struct avl_tree_node*)handle;
...
extern inline int avl_tree_node_set_left_son(avl_tree_node_t handle, avl_tree_node_t left_son) {
	struct avl_tree_node* avl_tree_node = (struct avl_tree_node*)handle;
...
extern inline int avl_tree_node_set_right_son(avl_tree_node_t handle, avl_tree_node_t right_son) {
	struct avl_tree_node* avl_tree_node = (struct avl_tree_node*)handle;
...
extern inline int avl_tree_node_is_left_son(avl_tree_node_t handle) {
	struct avl_tree_node* avl_tree_node = (struct avl_tree_node*)handle;
	return bst_node_is_left_son(avl_tree_node->node);
}

extern inline int avl_tree_node_is_right_son(avl_tree_node_t handle) {
	struct avl_tree_node* avl_tree_node = (struct avl_tree_node*)handle;

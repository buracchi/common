...
extern int parse_action_help(cmn_argparser_t argparser, int argc, const char** argv);
extern int print_usage(cmn_argparser_t argparser, int argc, const char** argv);
extern int print_help(cmn_argparser_t argparser, int argc, const char** argv);
extern char* format_usage(cmn_argparser_t argparser, int argc, const char** argv);
extern char* format_help(cmn_argparser_t argparser, int argc, const char** argv);
...
extern int parse_action_help(cmn_argparser_t argparser, int argc, const char** argv) {
	print_help(argparser, argc, argv);
	exit(EXIT_SUCCESS);
}

extern int print_usage(cmn_argparser_t argparser, int argc, const char** argv) {
	char* usage_message;
	usage_message = format_usage(argparser, argc, argv);
	fprintf(stdout, "%s\n", usage_message);
	free(usage_message);
	return 0;
}
...
extern int print_help(cmn_argparser_t argparser, int argc, const char** argv) {
	char* help_message;
	help_message = format_help(argparser, argc, argv);
